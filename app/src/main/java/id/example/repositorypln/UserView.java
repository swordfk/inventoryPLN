    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pinjam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(UserView.this, MainUser.class));
            }
        });
        riwayat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(UserView.this, PermintaanUser.class));
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.changePassword:
                //Do Logout
                Dialog dialog2 = new Dialog(UserView.this);
                ...
                konfirmasi.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (passwordLama.getText().toString().length() !=0){
                                                ...
                                                user.updatePassword(newPassword.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            loading.dismiss();
                                                            dialog2.cancel();
                                                            Toast.makeText(UserView.this, "Password berhasil di ubah", Toast.LENGTH_SHORT).show();
                            ...
                            loading.dismiss();
                            Toast.makeText(UserView.this, "Masukkan password lama", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                break;
